...
/**
 * @ORM\Entity
 * @ORM\Table(name="secnews")
 */
class Secnews implements InputFilterAwareInterface {
    ...
    public function exchangeArray($data) {
        ...
        $this->media_link = (isset($data['media_link'])) ? $data['media_link'] : null;
