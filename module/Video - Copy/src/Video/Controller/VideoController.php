...
return new JsonModel($arrayff);die;
// DB table to use
        $table = 'video';
         ...
         */
        //require( __DIR__ . '/../../../../../public/plugins/datatables/server_side/ssp.class.php' );
        echo "<pre>";print_r(Sspclass::simple( $_GET, $sql_details, $table, $primaryKey, $columns ));die;
        echo json_encode(
            Sspclass::simple( $_GET, $sql_details, $table, $primaryKey, $columns )
        );
    }
