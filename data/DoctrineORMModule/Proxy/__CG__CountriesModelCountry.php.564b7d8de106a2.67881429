...
namespace DoctrineORMModule\Proxy\__CG__\Countries\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Country extends \Countries\Model\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'id', 'name', 'arname', 'active');
        }
    ...
    public function getArname()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getArname', array());

        return parent::getArname();
    }
