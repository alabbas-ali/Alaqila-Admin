 ...
 */
class Audio implements InputFilterAwareInterface {
    ...
    public function exchangeArray($data) {
        ...
        $this->audiolink = (isset($data['audiolink'])) ? $data['audiolink'] : null;
        $this->content = (isset($data['content'])) ? $data['content'] : null;
        $this->arcontent = (isset($data['arcontent'])) ? $data['arcontent'] : null;
        $this->country = (isset($data['country'])) ? $data['country'] : null;
        $this->user = (isset($data['user'])) ? $data['user'] : null;
        $this->audio_date = (isset($data['audio_date'])) ? $data['audio_date'] : date('Y-m-d');
    }
